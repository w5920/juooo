        ...
        return (
            <div className={myjuoooCss.myjuooo}>
                    ...
                    <div className={myjuoooCss.topMain}>
                        <div className={myjuoooCss.mineInfo}>
                            ...
                            <div className={myjuoooCss.mineInfo_msg}>
                                <p className={is_login ? myjuoooCss.mineInfo_userNameOne : myjuoooCss.mineInfo_userNameZero}>{is_login ? basic_info.nick_name : "登录/注册"}</p>
                                <p className={is_login ? myjuoooCss.mineInfo_userIdOne : myjuoooCss.mineInfo_userIdZero}>{is_login ? basic_info.uid : "点击登录>"}</p>
                            </div>
                        </div>
                ...
                <div className={myjuoooCss.myjuoooVipBanner}>
                    <a href="">
                        <img className={myjuoooCss.addVipImg} src={require("../../assets/img/adVip.png")} alt="" />
                    </a>
                </div>
