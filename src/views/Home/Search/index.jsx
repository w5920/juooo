            ...
            <div className={style["index-search"]}>
                <div className={style["head"]}>
                    <div className={style["search-ipt"]}>
                        <img className={style["search-left"]} src={require("../../../assets/img/search.png")} alt="" />
                        <input onChange={(e) => {
                        ...
                        }} ref={el => this.ipt = el} type="text" placeholder={"搜索热门演出"} />
                        <img onClick={() => {
                            this.searchValue = ""
                            this.ipt.value = ""
                            this.props.getSearchDate.call(this, "")
                        }} className={style["search-left"]} src={require("../../../assets/img/x.png")} alt="" />
                    </div>
                    <span onClick={() => {
                                ...
                                <div className={style["hots-search"]}>
                                    {
                                        JSON.parse(localStorage.getItem("arr")).length > 0 ? (
                                            <React.Fragment>
                                                <p style={{ position: "relative" }}>历史搜索
                                                 <img style={{
                                                        position: "absolute",
                                                        top: "0",
                                                        right: "0",
                                                        ...
                                                        src={require("../../../assets/img/delete.png")} alt="" />
                                                </p>
                                                <ul style={{ marginBottom: "0.8rem" }}>
                                                    {
                                                        JSON.parse(localStorage.getItem("arr")).map(v => (
                                                            <li onClick={(e) => {
                                                                ...
                                                                this.props.getSearchDate.call(this, this.searchValue)
                                                            }} key={Math.random() * (9999 - 1000) + 10}>{v}</li>
                                                        ))
                                                    }
                                                </ul>
                                            </React.Fragment>
                                    ...
                                    <ul>
                                        {
                                            this.props.hortSearch.length > 0 ? this.props.hortSearch.map(v => (
                                                <li onClick={(e) => {
                                                    this.searchValue = e.target.innerText
                                                    const arr = JSON.parse(localStorage.getItem("arr"))
                                                    ...
                                                    localStorage.setItem("arr", JSON.stringify(arr))
                                                    this.props.getSearchDate.call(this, this.searchValue)
                                                }} key={Math.random() * (9999 - 1000) + 10}>{v.word}</li>
